...
class SuperPixDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, name):
        ...
        with open(data_dir+name+'_new.pkl',"rb") as f:
            f = pickle.load(f)
            self.train = f[0]
            self.val = f[1]
        ...
        #random.seed(10)
        #random.shuffle(li)
        #train1 = [self.train[n][0] for n in li[:20000]]
        #train2 = [self.train[n][1] for n in li[:20000]]

        #val1 = [self.train[n][0] for n in li[20000:25000]]
        #val2 = [self.train[n][1] for n in li[20000:25000]]
