...
#wait" C-m
tmux send-keys "
python $code --dataset $dataset --gpu_id 0 --train_str $train_str --seed $seed0 --lrbl $lrbl --lambdap $lambdap --config 'configs/superpixels_graph_classification_DiffPool_Molclintox_100k.json' &
#python $code --dataset $dataset --gpu_id 1 --train_str $train_str --seed $seed1 --lrbl $lrbl --lambdap $lambdap --config 'configs/superpixels_graph_classification_DiffPool_Molclintox_100k.json' &
#python $code --dataset $dataset --gpu_id 2 --train_str $train_str --seed $seed2 --lrbl $lrbl --lambdap $lambdap --config 'configs/superpixels_graph_classification_DiffPool_Molclintox_100k.json' &
#python $code --dataset $dataset --gpu_id 3 --train_str $train_str --seed $seed3 --lrbl $lrbl --lambdap $lambdap --config 'configs/superpixels_graph_classification_DiffPool_Molclintox_100k.json' &
wait" C-m
#tmux send-keys "
...
#python $code --dataset $dataset --gpu_id 2 --train_str $train_str --seed $seed3 --config 'configs/superpixels_graph_classification_GraphSage_MNIST_100k.json' &
