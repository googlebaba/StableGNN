...
#wait" C-m
tmux send-keys "
python $code --dataset $dataset --gpu_id 0 --train_str $train_str --lrbl $lrbl --lambdap $lambdap --seed $seed0 --config 'configs/superpixels_graph_classification_DiffPool_Molbace_100k.json' &
#python $code --dataset $dataset --gpu_id 1 --train_str $train_str --lrbl $lrbl --lambdap $lambdap --seed $seed1 --config 'configs/superpixels_graph_classification_DiffPool_Molbace_100k.json' &
#python $code --dataset $dataset --gpu_id 2 --train_str $train_str --lrbl $lrbl --lambdap $lambdap --seed $seed2 --config 'configs/superpixels_graph_classification_DiffPool_Molbace_100k.json' &
#python $code --dataset $dataset --gpu_id 3 --train_str $train_str --lrbl $lrbl --lambdap $lambdap --seed $seed3 --config 'configs/superpixels_graph_classification_DiffPool_Molbace_100k.json' &
wait" C-m
#tmux send-keys "
